...
description: I made this game for the 2017 Game Maker's Toolkit Jam. You incarnate a balloon and try to survive in a deadly desert !
---
...
<Carousel
  client:visible
  data={[1, 2, 3, 4].map((i) => ({
    image: `/assets/posts/Pshiiit/screen${i}.png`,
  }))}
/>
## Download the game

<iframe frameborder="0" src="https://itch.io/embed/159263" width="100%">
  <a href="https://gabrielvidal.itch.io/pshiiit">Pshiiit! by Gabriel Vidal</a>
</iframe>
